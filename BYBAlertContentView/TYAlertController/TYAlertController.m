...
- (void)keyboardWillShow:(NSNotification*)notification{
    ...
    if (differ >= 0) {
        if (self.isBottomDisplay) {
             _alertViewCenterYConstraint.constant =_alertViewCenterYOffset - differ;
        }else
        {
             _alertViewCenterYConstraint.constant =_alertViewCenterYOffset-(CGRectGetHeight(self.view.frame) -  CGRectGetHeight(_alertView.frame))/2;//_alertViewCenterYOffset - differ;
        }
        //_alertViewCenterYConstraint.constant =_alertViewCenterYOffset-(CGRectGetHeight(self.view.frame) -  CGRectGetHeight(_alertView.frame))/2;//_alertViewCenterYOffset - differ;
